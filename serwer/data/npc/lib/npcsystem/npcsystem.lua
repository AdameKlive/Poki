...
if NpcSystem == nil then
	-- Ładuje podstawowe klasy systemu NPC.
	...
	-- Słowa kluczowe do powitania i pożegnania. Więcej informacji na początku modules.lua
	FOCUS_GREETWORDS = {'cześć', 'witaj', 'hi'}
	FOCUS_FAREWELLWORDS = {'żegnaj', 'do widzenia', 'bye'}

	-- Słowo kluczowe do prośby o okno handlu. Więcej informacji na początku modules.lua
	SHOP_TRADEREQUEST = {'handluj', 'trade'}

	-- Słowo kluczowe do akceptowania/odrzucania oferty. MOŻE ZAWIERAĆ TYLKO JEDNO POLE! Więcej informacji na początku modules.lua
	SHOP_YESWORD = {'tak', 'y'}
	SHOP_NOWORD = {'nie', 'n'}

	-- Wzór używany do uzyskania ilości przedmiotu, który gracz chce kupić/sprzedać.
	PATTERN_COUNT = '%d+'

	-- Zachowanie opóźnienia rozmowy. Więcej informacji na początku npchandler.lua.
	NPCHANDLER_TALKDELAY = TALKDELAY_ONTHINK

	-- Stałe ciągi znaków definiujące słowa kluczowe do zastąpienia w domyślnych wiadomościach.
	--	Więcej informacji na początku npchandler.lua...
	...
	-- Pobiera parametr NPC o określonym kluczu. Zwraca nil, jeśli nie znaleziono takiego parametru.
	...
	-- Parsuje wszystkie znane parametry dla NPC. Parsuje również moduły parsowalne.
